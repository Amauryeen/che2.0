...
export default function Form(props: {
  attendee: MeetingAttendee & { user: User };
  ...
  const schema = yup.object({
    ...
    procurer: yup
      ...
      .test(
        'has-procurer',
        'Veuillez sélectionner un participant à qui remettre la procuration',
        function (value) {
  ...
  function handleSave(formValues: any) {
    toast.promise(setMeetingPresence(props.attendee.id, formValues), {
      loading: 'Modification de la présence en cours...',
      success: () => {
          ...
          <FormControl error={!!errors.presence} fullWidth>
            <Controller
              ...
              render={({ field: { value, onChange, ...fieldProps } }) => {
                return (
                  <>
                    <InputLabel id="presence">
                      {'Présence de ' +
                        props.attendee.user.firstName +
                        ' ' +
                        props.attendee.user.lastName}
                    </InputLabel>
                    <Select
                      {...fieldProps}
                      labelId="presence"
